...
function TenantStyles() {
  return (
    <style jsx global>{`
      .utShell{min-height:100vh;background:#F5F7FB;color:#101828;font-family:"Segoe UI Variable","Aptos",ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;display:grid;grid-template-columns:238px minmax(0,1fr)}
